...
main_pic = Image.open("back_template_large.png")
...
plate_description_short = input("Please enter the test for the back of the plate above the QR code.")
...
new_text = textwrap.TextWrapper(width=90)
string = new_text.fill(text=text_descript)
draw.text((110, 140), string, font=fnt2, fill="black")
#print(new_text)
main_pic.save(os.path.join(path, new_image))
